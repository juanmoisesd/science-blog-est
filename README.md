...
> de la Serna, J. M. (2026). *Science Blog Est*. Universidad Internacional de La Rioja (UNIR).
> https://github.com/juanmoisesd/science-blog-est 

See `CITATION.cff` for formatted references.

## Overview
This repository contains data and resources related to **science blog est**. It is part of an open science initiative to share research findings and datasets with the global scientific community.
